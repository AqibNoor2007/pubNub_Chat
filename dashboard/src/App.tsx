...
const channel = 'supportChannel.john'
...
const SupportDashboard = () => {
  ...
  const [activeChatChannel, setActiveChatChannel] = useState('supportChannel.john');
  ...
  //       },
  //       (status, response) => {
  //         console.log("activeChatChannel", activeChatChannel);
              ...
              if (message.sender === "agent") {
                ...
                return (
                  <Message key={`message-${messageIndex}`}>
                      <AgentName> Jhon(Client)</AgentName>
                      <AgentAvatar>
                          <AgentAvatarImg
